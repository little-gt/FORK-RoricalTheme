...
<section class="section section-components bg-secondary">
    <div class="container container-lg py-5 align-items-center" style="text-align: center;">
        <br>
        <br>
        <h2 class="display-2" style="width: 85%; margin: auto;">
            <a class="nav-link mb-sm-3 mb-md-0 active" style="width: 85%; margin: auto;" id="tabs-icons-text-1-tab">
                <div class="card-profile-image">
                </div>
                <span class="text-info card card-profile shadow" style="width: 85%; margin: auto;">
    ...
    <nav class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <?php $this->pageNav('<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>', 1, '...', array(
                    'wrapTag' => 'ul',
