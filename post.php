            ...
            <div class="card card-profile shadow mt--250">
                <div class="px-4">
                    <div class="text-center mt-5" style="margin: 50px auto;">
                        ...
                        <br>
                        <div class="h6 font-weight-300"><i class="ni location_pin mr-2"></i><a href="<?php $this->author->permalink(); ?>" rel="author"><?php $this->author(); ?></a> <time style="margin:auto 10px;" datetime="<?php $this->date('c'); ?>"><?php $this->date(); ?></time></div>
                    </div>
                            ...
                            <div class="card-profile-actions card-profile-stats d-flex justify-content-center">
                                <?php if (count($this->tags) > 0): ?>
                                    <?php foreach ($this->tags as $tag): ?>
                                        <a href="<?php print($tag['permalink']); ?>" class="btn btn-sm btn-info mr-4"><?php print($tag['name']); ?></a>
                                    <?php endforeach; ?>
                                <?php else: ?>
