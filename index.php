                                                ...
                                                <span>
                                                    <?php if (count($this->tags) > 0): ?>
                                                        ...
                                                        <?php foreach ($this->tags as $tag): ?>
                                                            <a href="<?php print($tag['permalink']); ?>" class="badge badge-success"><?php print($tag['name']); ?></a>
                                                        <?php endforeach; ?>
                                                    <?php else: ?>
    ...
    <nav class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <?php $this->pageNav('<i class="fa fa-angle-left"></i>', '<i class="fa fa-angle-right"></i>', 1, '...', array('wrapTag' => 'ul', 'wrapClass' => 'pagination pagination-lg justify-content-center', 'itemTag' => 'li', 'textTag' => 'a', 'currentClass' => 'page-item active', 'prevClass' => 'page-item', 'nextClass' => 'page-item', 'linkClass' => 'page-link', 'itemClass' => 'page-item')); ?>
            </div>
        </div>
    </nav>
    <?php if ($this->_currentPage > 1): ?>
        <script>
            $('html,body').animate({ scrollTop: $('.section.section-components.bg-secondary').offset().top }, 500);
        </script>
    <?php endif; ?>
</section>
